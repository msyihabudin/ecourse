                          ...
                          <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'admin/add_edit' ?>" class="form-label-left">
                            <div class="box-body box-profile">
                              <div class="col-md-3">
                                ...
                                <?php  
                                  if(file_exists('assets/image/user/'.$account[0]->profile_pic) && isset($account[0]->profile_pic)){
                                  $profile_pic = $account[0]->profile_pic;
                                  }else{
                                  $profile_pic = 'user.png';}?>
                                  <center> <img class="thumb-image setpropileam" src="<?php echo base_url();?>assets/image/user/<?php echo isset($profile_pic)?$profile_pic:'user.png';?>" alt="User profile picture" style="width: 241px; height: 240px;"></center>
                                </div>
                                <br>
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group has-feedback clear-both">
                                  ...
                                  <input type="text" id="name" name="name" value="<?php echo (isset($account[0]->name)?$account[0]->name:'');?>" required="required" class="form-control" placeholder="Name">
                                  <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                </div>                                

                                <div class="form-group has-feedback clear-both">
                                  <label for="exampleInputemail">Email:</label>
                                  <input type="text" id="email" name="email" value="<?php echo (isset($account[0]->email)?$account[0]->email:'');?>" required="required" class="form-control" placeholder="Email">
                                  <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                </div>                                        
                                <br>
                                ...
                                <div class="form-group has-feedback sub-btn-wdt" >
                                  <input type="hidden" name="users_id" value="<?php echo isset($account[0]->users_id)?$account[0]->users_id:''; ?>">
                                  <input type="hidden" name="user_type" value="<?php echo isset($account[0]->user_type)?$account[0]->user_type:''; ?>">
