                        ...
                        <tr>
                            <td valign="top" align="center" class="masthead" style="padding:20px 0;background:#03618c;color:white;">
                                <h1 style="font-size:32px;margin:0 auto;max-width:90%;line-height:1.25;">
                                    <a href="<?= site_url(); ?>" target="_blank" style="text-decoration:none;color:#ffffff;">TECHARISE</a>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;">
                                    <tr>
                                        <td valign="top" class="content thanksMsg" style="background:white;padding:10px 35px 20px 35px;">
                                            <p style="font-size:14px;font-weight:normal;margin-top:0;margin-bottom:5px;"><?= $thanksMsg; ?></p>
                                            <p style="font-size:14px;font-weight:normal;margin-top:0;margin-bottom:5px;"><?= $delimeter; ?></p>
                                        </td>
                                    </tr>                                    
                                </table>
                            </td>
