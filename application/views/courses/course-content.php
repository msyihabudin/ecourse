    ...
    <div class="ui container">
        ...
        <?php if (isset($this->session->userdata['user_signed_in'])) { ?>            
            <?php if ($enroll['enroll_status']) { ?>
                <a class="ui large black button" href="<?= site_url('courses/unenroll/'.$enroll['id_enroll_course'].'/'.$user['id_course'].'/'.$enroll['enroll_status']); ?>">Enrolled</a>    
            <?php } else { ?>
                <a class="ui large black button" href="<?= site_url('courses/enroll/'.$user['id_user'].'/'.$user['id_course']); ?>">Enroll Now</a>    
            <?php } ?>
        <?php } else { ?>
        ...
        <div class="ui stackable grid">
                            ...
                            <div class="ui segment">
                                <div class="ui stackable middle aligned grid">
                                    ...
                                    <div class="thirteen wide column">
                                        ...
                                        <a href="<?= site_url('courses/download/'.$content[0]->courseFile); ?>"><h2><?= $course->courseName; ?></h2></a>
            ...
            <div class="four wide column">
                <div class="ui center aligned container">
                    <div class="ui card">
                        <div class="image">
                            <img src="<?= $content[0]->courseBadge; ?>" alt="<?= $content[0]->name; ?>" />
                        </div>
                        <div class="content">
                            <div class="header">
                                Courses
