		...
		<div class="row">
			...
			<div class="col-lg-8">
				<div class="blog_content">
					...
					<div class="blog_meta">
						<ul>
							<li>Post on <a href="#"><?= $news['date_posted'] ?></a></li>
							<li>By <a href="#"><?= $news['display_name'] ?></a></li>
						</ul>
					</div>
					<div class="blog_image"><img src="<?= base_url('/assets/image/posts/' . $news['feature_image']); ?>" alt=""></div>
					<p><?= $news['content'] ?></p>
				</div>
				<div class="blog_extra d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
					<div class="blog_tags">
						<span>Tags: </span>
						<ul>
							<?php foreach ($news['categories'] as $cat): ?>
