		...
		<div class="row">
			...
			<div class="col-lg-8">
				<div class="blog_content">
					...
					<div class="blog_meta">
						<ul>
							<li>Post on <a href="#"><?= $blog['date_posted'] ?></a></li>
							<li>By <a href="#"><?= $blog['display_name'] ?></a></li>
						</ul>
					</div>
					<div class="blog_image"><img src="<?= base_url('/assets/image/posts/' . $blog['feature_image']); ?>" alt=""></div>
					<p><?= $blog['content'] ?></p>
				</div>
