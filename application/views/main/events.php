        ...
        <div class="row">
            <div class="col">
                <div class="section_title_container text-center">
                    <h2 class="section_title">Welcome To E-Course</h2>
...
<div class="feature">
    <div class="feature_background" style="background-image:url(<?= base_url("assets/frontend/images/courses_background.jpg");?>)"></div>
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="section_title_container text-center">
        ...
        <div class="row feature_row">
            ...
            <div class="col-lg-6 feature_col">
                <div class="feature_video d-flex flex-column align-items-center justify-content-center">
                    <div class="feature_video_background" style="background-image:url(<?= base_url("assets/frontend/images/video.jpg");?>)"></div>
            ...
            <div class="col">
                <div class="partners_slider_container">
                    <div class="owl-carousel owl-theme partners_slider">
                        ...
                        <!-- Partner Item -->
                        <div class="owl-item partner_item"><img src="<?= base_url("assets/frontend/images/partner_1.png");?>" alt=""></div>

                        <!-- Partner Item -->
                        <div class="owl-item partner_item"><img src="<?= base_url("assets/frontend/images/partner_2.png");?>" alt=""></div>

                        <!-- Partner Item -->
                        <div class="owl-item partner_item"><img src="<?= base_url("assets/frontend/images/partner_3.png");?>" alt=""></div>

                        <!-- Partner Item -->
                        <div class="owl-item partner_item"><img src="<?= base_url("assets/frontend/images/partner_4.png");?>" alt=""></div>

                        <!-- Partner Item -->
                        <div class="owl-item partner_item"><img src="<?= base_url("assets/frontend/images/partner_5.png");?>" alt=""></div>

                        <!-- Partner Item -->
                        <div class="owl-item partner_item"><img src="<?= base_url("assets/frontend/images/partner_6.png");?>" alt=""></div>
