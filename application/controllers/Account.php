...
class Account extends CI_Controller {
	...
	public function index() {
        if (isset($this->session->userdata['user_signed_in'])) {
            ...
            $data['enroll_course'] = json_decode($this->accountmodel->getKeepPlayingCourses($user['id_user']));
            $data['enroll_lesson'] = json_decode($this->accountmodel->getKeepPlayingQuest($user['id_user']));
